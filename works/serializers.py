...
class AutoDockSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AutoDock
        fields = ('user','work_name','work_decs' ,'size_x','size_y','size_z','center_x','center_y','center_z','pdb_file','lig_file')
...
class AutoDock2Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AutoDock2
        fields = ('user','work_name','work_decs' ,'pdb_file','resi_file','lig_file')
...
class VirtualScreenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = VirtualScreen
        fields = ('user','work_name','work_decs','size_x' ,'size_y','size_z','center_x','center_y','center_z','pdb_file','user_db')
...
class VirtualScreen2Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = VirtualScreen2
        fields = ('user','work_name','work_decs','pdb_file','resi_file','user_db')
